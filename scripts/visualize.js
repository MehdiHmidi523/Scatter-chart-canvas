...
function xRelativeValue(value){
  var ctx = canvas.getContext('2d'),height = canvas.height,width = canvas.width;
...
function recalculate(oldDistance, oldSize, newSize){
  return oldDistance * newSize / oldSize;
}
